...
with open('/Users/mac/project/used_retail/app/model_to_factory_price_dict.pickle', 'rb') as f:
    model_to_factory_price_dict = pickle.load(f)
    
with open('/Users/mac/project/used_retail/app/col_to_index_dict.pickle', 'rb') as f:
    col_to_index_dict = pickle.load(f)
    
with open('/Users/mac/project/used_retail/app/common_words.pickle', 'rb') as f:
    common_words = pickle.load(f)

with open('/Users/mac/project/used_retail/app/init_vectorizer_vocabulary.pickle', 'rb') as f:
    init_vectorizer_vocabulary = pickle.load(f)
    
with open('/Users/mac/project/used_retail/app/tfidf_vectorizer.pickle', 'rb') as f:
    tfidf_vectorizer = pickle.load(f)
    
with open('/Users/mac/project/used_retail/app/svm_classifier.pickle', 'rb') as f:
    svm_classifier = pickle.load(f)

rf_regressor = joblib.load('/Users/mac/project/used_retail/app/rf_regressor.pickle')
